...
mod test {
    ...
    fn should_initialize_sftp_filesystem() {
        let mut client = SftpFileSystem::new(SshOpts::new("127.0.0.1"));
    ...
    fn setup_client() -> TestCtx {
        ...
        let mut client = SftpFileSystem::new(
            SshOpts::new("sftp")
    ...
    fn finalize_client(mut client: SftpFileSystem) {
        // Get working directory
        let wrkdir = client.pwd().ok().unwrap();
        // Remove directory
