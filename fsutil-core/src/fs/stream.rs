...
/// The stream returned by [`crate::RemoteFileSystem`] to read a file from the remote server
...
/// The stream returned by [`crate::RemoteFileSystem`] to write a file from the remote server
